...
(한 노드 당 모든 노드에 도달할 수 있는 경우(!= INF)의 수 합이 N일때, 순위를 알 수 있다.)
"""

# 아래 그림 보면서 이해
# https://blex.me/@mildsalmon/chap-17-%EC%B5%9C%EB%8B%A8%EA%B2%BD%EB%A1%9C-q38-%EC%A0%95%ED%99%95%ED%95%9C-%EC%88%9C%EC%9C%84
